  ...
  return (
    ...
    >
      ...
      >
        ...
        <SubMenu label="Luyện tập" icon={<i className='tabler-book' />}>
          <MenuItem href='/practice/exam' icon={<i className='tabler-file-text' />}>
            Làm đề thi thử
          </MenuItem>
          <MenuItem href='/practice/review' icon={<i className='tabler-clipboard-check' />}>
            Review đề đã làm
          </MenuItem>
        </SubMenu>
        <MenuItem href='/ai-chat' icon={<i className='tabler-message-circle' />}>
          Hỏi đáp AI
        </MenuItem>
        <MenuItem href='/progress' icon={<i className='tabler-chart-bar' />}>
          Báo cáo tiến độ
        </MenuItem>
